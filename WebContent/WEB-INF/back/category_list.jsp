			...
			<div class="row">
				<div class="col-md-2">
					<div class="list-group">
						<a href="${ctx}/category/findParentCategory.action" class="list-group-item active">商品列表</a> 
						<a href="${ctx}/category/getAddParentCategory.action" class="list-group-item">添加父类</a>
						<a href="${ctx}/category/getAddCategory.action" class="list-group-item">添加子类</a>
					</div>
				</div>
				<div class="col-md-10">
					...
					<table class="table container">
						...
						<c:forEach items="${Parentlist}" var="category">
							<tr>
								...
								<td>
									<a href="${ctx}/category/findCategory.action?id=${category.id}">查看子类</a>
								</td>
								<td><a
									href="${ctx}/category/deleteParentById.action?id=${category.id}">删除</a></td>
								<td><a
									href="${ctx}/category/findParentById.action?id=${category.id}">修改</a></td>

...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${ctx}/resources/back/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx}/resources/back/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="${ctx}/resources/back/css/animate.css" rel="stylesheet">
    <link href="${ctx}/resources/back/css/style.css?v=4.1.0" rel="stylesheet">
</head>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">商品统计</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${ctx}/product/findAll.action">商品列表</a>
                            </li>
                            <li>
    ...
    <!-- 自定义js -->
    <script src="${ctx}/resources/back/js/hAdmin.js?v=4.1.0"></script>
    <script type="text/javascript" src="${ctx}/resources/back/js/index.js"></script>

    <!-- 第三方插件 -->
    <script src="${ctx}/resources/back/js/plugins/pace/pace.min.js"></script>

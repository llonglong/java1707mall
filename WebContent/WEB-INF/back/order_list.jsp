			...
			<div class="row">
				<div class="col-md-2">
					<div class="list-group">
						<a
							href="${ctx}/student/findPageBeanList.action"
				...
				<div class="col-md-10">
					<ul class="nav nav-tabs">
						<li class="active"><a
							href="${ctx}/students/findPageBeanList.action">商品列表</a>
						</li>
						<li><a
					...
					<table class="table container">
						...
						<c:forEach items="${list}" var="order">
							<tr>
								...
								<td>${order.userId}</td>
								<td>${order.payment}</td>
								<td><a href="${ctx}/order/findOrderItemByOrderNO.action?orderNo=${order.orderNo}">订单详情</a></td>
							</tr>
						</c:forEach>
					</table>
				</form>
